...
export class WorkflowDataService {
  ...
  createInquiry(payload: Partial<InquiryRecord>): Observable<InquiryRecord> {
    return this.http.post<any>(`${this.apiBase}/inquiries`, payload).pipe(map(response => this.unwrap(response)));
  }

  addFollowUp(inquiryId: number, payload: Partial<FollowUpRecord>): Observable<FollowUpRecord> {
    return this.http.post<any>(`${this.apiBase}/inquiries/${inquiryId}/follow-ups`, payload).pipe(map(response => this.unwrap(response)));
  }
  ...
  private getInquiries(): Observable<InquiryRecord[]> {
    return this.http.get<any>(`${this.apiBase}/inquiries`).pipe(
  ...
  private getFollowUps(inquiryId: number): Observable<FollowUpRecord[]> {
    return this.http.get<any>(`${this.apiBase}/inquiries/${inquiryId}/follow-ups`).pipe(
  ...
  private getAdmissions(): Observable<AdmissionApplication[]> {
    return this.http.get<any>(`${this.apiBase}/admissions`).pipe(
  ...
  private getStudentDocuments(studentId: number): Observable<StudentDocumentRecord[]> {
    return this.http.get<any>(`${this.apiBase}/students/${studentId}/documents`).pipe(

...
@Component({
    ...
    <div class="component-container">
      <div class="page-header"><h2><i class="pi pi-file-pdf"></i> Ledger Statement</h2><button pButton label="Back" icon="pi pi-arrow-left" class="p-button-text" routerLink="../../"></button></div>
      <div class="form-card"><p class="placeholder-text"><i class="pi pi-info-circle"></i> Ledger Statement - Printable statement for a contract</p></div>
    </div>
  `,

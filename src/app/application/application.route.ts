...
export const APPLICATION_ROUTES: Routes = [
  ...
  // ━━━ Academics module (Overview / Academic Year / Classes & Sections / Subjects / Teacher Allocation / Timetable + role pages) ━━━
  {
    ...
    children: [
      ...
      { path: 'classes-sections/:classId/subjects', data: { workspacePage: 'subjects-mapping', ...ACADEMICS_PAGES.classSubjects }, loadComponent: () => import('./academics/components/pages/class-subjects/class-subjects.component').then(m => m.ClassSubjectsPageComponent) },

...
export const academicsApi = {
  ...
  calendarEventsByYear: (yearId: number) => `${BASE}/academics/years/${yearId}/calendar/events`,
  calendarDashboard: (yearId: number) => `${BASE}/academics/years/${yearId}/calendar/events/dashboard`,
  calendarEvents: `${BASE}/academics/calendar/events`,
  calendarEventById: (id: number) => `${BASE}/academics/calendar/events/${id}`,
  calendarEventPublish: (id: number) => `${BASE}/academics/calendar/events/${id}/publish`,
  calendarEventUnpublish: (id: number) => `${BASE}/academics/calendar/events/${id}/unpublish`,
  calendarEventDeactivate: (id: number) => `${BASE}/academics/calendar/events/${id}/deactivate`,
  calendarEventReactivate: (id: number) => `${BASE}/academics/calendar/events/${id}/reactivate`,

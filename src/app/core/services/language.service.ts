...
const MENU_LABEL_KEYS: Record<string, string> = {
  ...
  Subscriptions: 'menu.subscriptionManagement',
  'Subscription Management': 'menu.subscriptionManagement',
  'Subscription Plans': 'menu.subscriptionPlans',
  Promotions: 'menu.promoCodes',
  'Promo Codes': 'menu.promoCodes',
...
const EN_FALLBACK: Dictionary = {
  ...
  'menu.subscriptions': 'Subscription Management',
  'menu.subscriptionManagement': 'Subscription Management',
  'menu.subscriptionPlans': 'Subscription Plans',
  'menu.promotions': 'Promo Codes',
